...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="text-dark">Discount List</h4>
                        ...
                        <div class="card-body">
                            <div class="row   border-bottom pb-2 mb-2">
                                ...
                                <div class="col-sm-12 text-right">
                                    <a href="javascript:void(0)" data-url="{{ route('admin.discount_type.create') }}"
                        ...
                        <table id="table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>{{ $data->name }}</td>
                                    <td>{{ $data->discount_by }}</td>
                                    <td>{{ $data->discount_for }}</td>
                                    <td>{{ $data->discount }}</td>
                                    <td class="text-right">
                                        <a href="{{ route('admin.discount_type.show', $data->id) }}"
                                        ...
                                        <a href="{{ route('admin.discount_type.edit', $data->id) }}"
                                            class="btn btn-outline-info"><span class="iconify"
                                                data-icon="mdi:circle-edit-outline" data-width="15"
                                                data-height="15"></span> Edit</a>
                                        <a href="{{ route('admin.discount_type.delete', $data->id) }}"
