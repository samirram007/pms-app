    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark py-2">Edit Discount  </h4>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('admin.discount_type.update', $editData->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="discount_by" id="discount_by" class="form-control">
                                                    @foreach ($discount_by as $data)
                                                        <option value="{{ $data }}" {{ $editData->discount_by==$data?'selected':''}}>{{ $data }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="discount_for" id="discount_for" class="form-control">
                                                    @foreach ($discount_for as $data)
                                                        <option value="{{ $data }}" {{ $editData->discount_for==$data?'selected':''}}>{{ $data }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="discount">Value</label>
                                                 <input type="number" class="form-control" id="discount" name="discount" value="{{ $editData->discount }}"
