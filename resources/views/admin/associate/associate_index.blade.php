    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark">Associate List</h4>
                            ...
                            <div class="card-body">
                                <div class="row   border-bottom pb-2 mb-2">
                                    ...
                                    <div class="col-sm-12 text-right">
                                        <a href="{{ route('admin.associate.create') }}"
                                ...
                                <tbody>
                                    @foreach ($collections as $key=> $data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.associate.show', $data->id) }}"
