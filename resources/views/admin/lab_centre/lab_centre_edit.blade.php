    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark py-2">Edit Lab Centre </h4>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a href="{{ route('admin.lab_centre.index') }}" class="text-active">Lab Centre
                                    List</a></li>
                            <li class="breadcrumb-item active">  Edit Lab Centre</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('admin.lab_centre.update', $editData->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    value="{{ $editData->name }}" placeholder="Enter Lab Centre Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="code" name="code"
                                                    value="{{ $editData->code }}" placeholder="Enter Lab Centre Code">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
