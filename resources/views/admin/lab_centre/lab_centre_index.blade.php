...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="text-dark">Lab Centre List</h4>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right border-0">
                        ...
                        <li class="breadcrumb-item active">Lab centre list</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                            <div class="row   border-bottom pb-2 mb-2">
                                ...
                                <div class="col-sm-12 text-right">
                                    <a href="javascript:void(0)" data-url="{{ route('admin.lab_centre.create') }}"
                        ...
                        <table id="table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('admin.lab_centre.show', $data->id) }}"
                                        ...
                                        <a href="{{ route('admin.lab_centre.edit', $data->id) }}"
                                            class="btn btn-outline-info"><span class="iconify"
                                                data-icon="mdi:circle-edit-outline" data-width="15"
                                                data-height="15"></span> Edit</a>
                                        <a href="{{ route('admin.lab_centre.delete', $data->id) }}"
