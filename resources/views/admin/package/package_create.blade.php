<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel">ADD NEW PACKAGE</h1>
                ...
                <div class="card-body">
                    {{-- <div class="row   border-bottom pb-2 mb-2">
                        <div class="col-sm-12 text-right">
                            <button type="submit" class="load-popup float-right btn btn-rounded btn-info "> Save
                                package</button>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="discount" name="discount"
                                    placeholder="Enter Package Discount" value="5">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
        ...
        <div class="modal-footer">
            <button type="submit" class="load-popup float-right btn btn-rounded btn-outline-info ">
                <span class="iconify" data-icon="lucide:package-plus" data-width="15" data-height="15"></span>
