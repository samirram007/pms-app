                                    ...
                                    @foreach ($collections as $key=> $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if(!empty($data->image))
                                                <img
                                                style="border-radius:2px; width: 80px; height:50px; border:1px solid #00000011;"
                                                src="{{ !empty($data->image) ? url('upload/user_images/' . $data->image) : url('upload/no_image.jpg') }}"
                                                alt="">
                                                @else
                                                <span class="iconify" data-icon="bi:credit-card-2-back-fill" style="color: rgb(9, 90, 145);" data-width="50" data-height="50"></span>
                                                @endif
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route($show_route, $data->id) }}"
                                                ...
                                                <a href="{{ route($edit_route, $data->id) }}"
