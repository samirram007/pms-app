                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a href="{{ route($index_route) }}" class="text-active">Discount
                                    List</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{ route($update_route, $editData->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls ">
                                                    <img id="showImage" class=" "
                                                        style="cursor:pointer;border-radius:2px; width: 80px; height:50px; border:1px solid #00000011;"
