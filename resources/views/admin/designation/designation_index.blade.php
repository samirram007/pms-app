...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="text-dark">Designation List</h4>
                        ...
                        <div class="card-body">
                            <div class="row   border-bottom pb-2 mb-2">
                                ...
                                <div class="col-sm-12 text-right">
                                    <a href="javascript:void(0)" data-url="{{ route('admin.designation.create') }}"
                        ...
                        <table id="table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->name }}</td>
                                    <td>
                                        <a href="{{ route('admin.designation.show', $data->id) }}"
                                        ...
                                        <a href="{{ route('admin.designation.edit', $data->id) }}"
                                            class="btn btn-outline-info"><span class="iconify"
                                                data-icon="mdi:circle-edit-outline" data-width="15"
                                                data-height="15"></span> Edit</a>
                                        <a href="{{ route('admin.designation.delete', $data->id) }}"
