    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark py-2">Create Employee </h4>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a href="{{ route('admin.employee.index') }}" class="text-active">Employee
                                    List</a></li>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control " name="department_id" id="department_id">
                                                    <option value="" style=" font-weight: bold"
                                                        data-has-attributes="0">Select Department </option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control " name="designation_id" id="designation_id">
                                                    <option value="" style=" font-weight: bold" data-has-attributes="0">Select Designation </option>
