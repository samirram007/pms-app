    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark py-2">Edit Test Category </h4>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a href="{{ route('admin.test_category.index') }}" class="text-active">Test Category List</a></li>
                            <li class="breadcrumb-item active">  Edit Test Category</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('admin.test_category.update', $editData->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group  ">
                                                ...
                                                <select class="form-control" name="has_method" id="has_method">
                                                    <option value="0" {{$editData->has_method==false?'selected':''}}>No</option>
                                                    <option value="1" {{$editData->has_method==true?'selected':''}}>Yes</option>
                                                </select>
