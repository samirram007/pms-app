    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark py-2">Edit Test </h4>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a href="{{ route('admin.test') }}" class="text-active">Test
                                    List</a></li>
                            ...
                            <form action="{{ route('admin.test.update', $editData->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group  ">
                                                ...
                                                <select class="form-control testgroup_select" name="test_group_id"
                                                    id="test_group_id" data-url="{{ route('admin.get-category-by-groupid') }}">
                                                    <option value="" class="text-bold">Select Group</option>

                                                    @forelse ($test_groups as $tg)
                                                        <option value="{{ $tg['id'] }}" {{ $editData->test_group_id ==$tg['id']? 'selected':'' }}>
                                                            {{ $tg['name'] }}
                                                        </option>
                                    ...
                                    <div class="row" id="Attributes" style="display: none;" data-aos="fade-in">
                                        <input type="hidden" id="has_method" name="has_method"
                                        value="{{ $editData->has_method }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control " name="test_unit_id" id="test_unit_id">
                                                    ...
                                                    @forelse ($test_units as $tu)
                                                        <option value="{{ $tu['id'] }}" {{$tu['id'] == $editData->test_unit_id ? 'selected':''}}>
                                                         {!! $tu['code'] !!}
                                                        </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group  ">
                                                ...
                                                <input type="text" class="form-control" name="specimen_type"
                                                    id="specimen_type" placeholder="Specimen"  value="{{$editData->specimen_type}}" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" class="form-control" name="test_method"
                                                    id="test_method" placeholder="TestMethod" value="{{$editData->test_method}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                ...
                                                <input type="text" class="form-control" name="reference_range"
                                                    id="reference_range" placeholder="ReferenceRange" value="{{$editData->reference_range}}">
                                            </div>
                                        </div>
