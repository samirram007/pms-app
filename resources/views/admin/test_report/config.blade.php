...
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills nav-pills-success pe-auto ">
                            <li class=" nav-item ">
                                <div id="load_tab" class="nav-link   border border-info text-primary "
                                    onclick="loadcode()">Load</div>
                            </li>
                            <li class=" nav-item ">
                            ...
                            <li class=" nav-item ">
                                <div id="home_tab" class="nav-link active">CODE</div>
                            </li>
                            <li class="nav-item">
                                <div id="html_tab" class="nav-link ">HTML VIEW</div>
                            </li>
                            <li class="nav-item d-none">
                                <div id="preview_tab" class="nav-link ">PDF VIEW</div>
                            </li>
                            <li class="nav-item d-none">
                                <div id="print_tab" onclick="printDiv();" class="nav-link ">Print</div>
                            </li>
                            <li class="nav-item d-none">
                                <div id="print_tab" onclick="GeneratePDF();" class="nav-link ">Generate PDF</div>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="menu1" class="tab-pane fade">
                                <div id="preview" class="position-relative">some text</div>
                            </div>
    ...
    <script>
        ...
        function printDiv() {
            var divContents = document.getElementById("pdf_view").innerHTML;
