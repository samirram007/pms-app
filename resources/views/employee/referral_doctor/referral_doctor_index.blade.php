    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark">Referral Doctor List</h4>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item active">Referral Doctor list</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <div class="row   border-bottom pb-2 mb-2">
                                    ...
                                    <div class="col-sm-12 text-right">
                                        <a href="{{ route('employee.referral_doctor.create') }}"
                                ...
                                <tbody>
                                    @foreach ($collections as $data)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('employee.referral_doctor.show', $data->id) }}"
