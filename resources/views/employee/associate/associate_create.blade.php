    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark py-2">Create Associate </h4>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a href="{{ route('employee.associate.index') }}" class="text-active">Associate
                                    List</a></li>
                            <li class="breadcrumb-item active">  Add Associate</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('employee.associate.store') }}" method="post"  >
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" size="10" required  class="form-control" id="contact_no" name="contact_no" value="{{old('contact_no')}}"
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control " name="lab_centre_id"
                                                    id="lab_centre_id" >
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control testcategory_select" name="collection_centre_id"
                                                    ...
                                                    <option value="" style=" font-weight: bold"
                                                        data-has-attributes="0">Select Collection Centre</option>
