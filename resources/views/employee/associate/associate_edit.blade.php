    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark py-2">Edit Associate </h4>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a href="{{ route('employee.associate.index') }}"
                                    class="text-active">Associate
                                    List</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary">
                            ...
                            <form action="{{ route('employee.associate.update', $editData->id) }}" method="post" >
                                @csrf
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    value="{{ $editData->name }}" placeholder="Enter Associate Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="code" name="code"
                                                    value="{{ $editData->code }}" placeholder="Enter Associate Id">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
