    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a
                                    href="{{ route('employee.sales_invoice.edit', $sales_invoice->id) }}"
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.pay1').click(function() {
                    const url = "{{ route('employee.sales_invoice.pay') }}";
                            ...
                            success: function(data) {
                                ...
                                if (data.status == 'success') {
                                    window.location.href =
                                        "{{ route('employee.sales_invoice.index') }}";
                                }
                            }
                        });
                    }
                ...
                $('.pay').click(function() {
                    const url = "{{ route('employee.sales_invoice.pay') }}";
                    const link = "{{ route('employee.sales_invoice.index') }}";
