    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="text-dark py-2">Create Patient </h4>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right border-0">
                            ...
                            <li class="breadcrumb-item "><a href="{{ route('employee.patient.index') }}" class="text-active">Patient
                                    List</a></li>
        ...
        {{-- patient/store --}}
                            <form action="{{ route('employee.patient.store') }}" method="post" enctype="multipart/form-data" >
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control " name="associate_id"
                                                    ...
                                                    <option value="" style=" font-weight: bold"
                                                        data-has-attributes="0">Select Associate</option>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control " name="referral_doctor_id"
